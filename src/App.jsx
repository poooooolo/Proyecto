...
function App() {
  ...
  useEffect(() => {
    fetch("https://apitodo-gs7p.onrender.com/todo")
  ...
  function actualizarEstado(id) {
    ...
    fetch(`https://apitodo-gs7p.onrender.com/todo/actualizar/${id}/2`, {
      method: "PUT"
    })
      .then(respuesta => respuesta.json())
      .then(({ resultado }) => {
  ...
  function borrarTarea(id) {
    ...
    fetch(`https://apitodo-gs7p.onrender.com/todo/borrar/${id}`, {
      method: "DELETE"
    })
      .then(respuesta => respuesta.json())
      .then(({ resultado }) => {
